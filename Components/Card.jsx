      ...
      {cardData.map((card, index) => (
        <div key={card.id} className="group my-10 flex w-full max-w-xs flex-col overflow-hidden rounded-lg border border-gray-300 bg-white shadow-md">
          <a className="relative mx-3 mt-3 flex h-60 overflow-hidden rounded-xl" href="#">
            ...
            <img src={card.hoverImage } class="rounded-full absolute top-0 left-0 opacity-0 transition-opacity duration-500 transform hover:opacity-100" alt="Nova imagem" />
          ...
          <div className="mt-4 px-5 pb-5">
            ...
            <p className="text-gray-700 mt-2">{card.description}</p> {/* Added description */}
